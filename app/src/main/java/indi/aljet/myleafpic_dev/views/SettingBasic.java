...
public class SettingBasic extends FrameLayout implements Themed {
    ...
    public SettingBasic(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public SettingBasic(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int minimumApi = a.getInteger(R.styleable
        .SettingBasic_settingMinApi,0);
        a.recycle();
