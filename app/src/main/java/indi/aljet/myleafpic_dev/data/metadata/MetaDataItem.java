...
public class MetaDataItem {
    ...
    private String make = null,model = null,
    fNumber = null,iso = null,exposureTime;
    private Date dateOriginal = null;
    private GeoLocation location = null;
    private int orientation = -1,height = -1,
    width = -1;

    static MetaDataItem getMetadata(@NotNull InputStream in)
        throws ImageProcessingException,IOException{
        return new MetaDataItem(in,true);
    }

    private MetaDataItem(InputStream in)
        throws ImageProcessingException,IOException{
...
//
//            if (dir1.containsTag(XmpDirectory.))
...
//        if(d != null) location  = d.getGeoLocation();
    ...
    private MetaDataItem(InputStream in,boolean resolution)
        throws ImageProcessingException,IOException{
        this(in);
        if(resolution ){
