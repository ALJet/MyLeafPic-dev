...
public class Media implements CursorHandler,
        Parcelable{
...
//        this.mimeType =
    ...
    public Media(Context context, Uri mediaUri){
        ...
        this.path = null;
        this.mimeType = context.getContentResolver()
                .getType(getUri());
    }


    public Media(@NotNull Cursor cur){
        this.uriString = cur.getString(0);
            ...
            public void run() {
                ...
                try{
                    ...
                    if(exifOrientation != -1){
                        ...
                        .TAG_ORIENTATION,String.valueOf(exifOrientation));
                        exif.saveAttributes();
                    }
