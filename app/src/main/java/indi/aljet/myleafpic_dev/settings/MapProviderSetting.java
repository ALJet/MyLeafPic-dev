...
import indi.aljet.myleafpic_dev.util.StaticMapProvider;

import static indi.aljet.myleafpic_dev.util.StaticMapProvider.GOOGLE_MAPS;
import static indi.aljet.myleafpic_dev.util.StaticMapProvider.MAP_BOX;
import static indi.aljet.myleafpic_dev.util.StaticMapProvider.MAP_BOX_DARK;
import static indi.aljet.myleafpic_dev.util.StaticMapProvider.MAP_BOX_LIGHT;
import static indi.aljet.myleafpic_dev.util.StaticMapProvider.TYLER;
        ...
        dialogBuilder.setPositiveButton(getActivity().getString(R.string.ok_action).toUpperCase(), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (mapProvider.getCheckedRadioButtonId()) {
                    ...
                    default:
                        Hawk.put(getActivity().getString(R.string.preference_map_provider), GOOGLE_MAPS.getValue());
                        break;
                    case R.id.radio_mapb_streets:
                        Hawk.put(getActivity().getString(R.string.preference_map_provider), MAP_BOX.getValue());
                        break;
                    case R.id.radio_osm_tyler:
                        Hawk.put(getActivity().getString(R.string.preference_map_provider), TYLER.getValue());
                        break;
                    case R.id.radio_mapb_dark:
                        Hawk.put(getActivity().getString(R.string.preference_map_provider), MAP_BOX_DARK.getValue());
                        break;
                    case R.id.radio_mapb_light:
                        Hawk.put(getActivity().getString(R.string.preference_map_provider), MAP_BOX_LIGHT.getValue());
                        break;
                }
            }
        });
