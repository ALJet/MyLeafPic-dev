...
public class SinglePhotoSetting extends ThemedSetting {
    ...
    public void show(){
        final AlertDialog.Builder dialogBuilder = new
                ...
                getActivity().getDialogStyle());

        View dialogLayout = LayoutInflater.from(getActivity()
        ).inflate(R.layout.dialog_media_viewer_theme,null);
        final SwitchCompat swApplyTheme = (SwitchCompat)
                dialogLayout.findViewById(R.id.sw_apply_theme);
        ...
        dialogLayout.findViewById(R.id.ll_apply_theme)
                .setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        swApplyTheme.setChecked(!swApplyTheme.
                                isChecked());
                        getActivity().setSwitchColor(getActivity()
                        .getAccentColor(),swApplyTheme);
                    }
                });
        getActivity().setSwitchColor(getActivity()
        .getAccentColor(),swApplyTheme);
        ...
        dialogBuilder.setPositiveButton(getActivity()
